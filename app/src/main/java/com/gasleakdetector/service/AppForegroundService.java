...
public class AppForegroundService extends Service {
    ...
    public static final String ACTION_EXIT  = "com.gasleakdetector.ACTION_EXIT";
    public static final String ACTION_START = "com.gasleakdetector.ACTION_START";
    public static final String ACTION_STOP  = "com.gasleakdetector.ACTION_STOP";
