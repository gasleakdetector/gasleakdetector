...
public class SharedPrefs {
    ...
    public void setWarningThreshold(int ppm) { prefs.edit().putInt(KEY_WARNING_THRESHOLD, ppm).apply(); }
    public int  getWarningThreshold()         { return prefs.getInt(KEY_WARNING_THRESHOLD, GasStatus.DEFAULT_WARNING_THRESHOLD); }

    public void setDangerThreshold(int ppm)   { prefs.edit().putInt(KEY_DANGER_THRESHOLD, ppm).apply(); }
    public int  getDangerThreshold()           { return prefs.getInt(KEY_DANGER_THRESHOLD, GasStatus.DEFAULT_DANGER_THRESHOLD); }
    ...
    public void resetToDefaults() {
        prefs.edit()
            ...
            .putInt(KEY_WARNING_THRESHOLD, GasStatus.DEFAULT_WARNING_THRESHOLD)
            .putInt(KEY_DANGER_THRESHOLD, GasStatus.DEFAULT_DANGER_THRESHOLD)
            .apply();
    }
}
